...
import { createProfessor } from "../../utils/professores/createProfessor";
import toast from "react-simple-toasts";
import { Toast } from "../../components/Toast";
import { LinkButton } from "../../components/LinkButton";

const initialCreateProfessor = {
  nome: "",
  sobrenome: "",
  area: "",
  data_nasc: new Date(),
...
export function CreateProfessor() {
  ...
  const [form, setForm] = useState(initialCreateProfessor);
  ...
  async function onSubmit(event: React.FormEvent) {
    ...
    await createProfessor(form)
      .then(() => {
        toast("O professor foi adicionado com sucesso", {
          render: (message) => (
            <Toast
      ...
      .catch(() => {
        toast("Não foi possível adicionar o professor", {
          render: (message) => (
            <Toast
